 ...
 */
class Version20170621111419 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE chain_size_table ADD position_field INT DEFAULT NULL');
        $this->addSql('ALTER TABLE insertion_color_table ADD position_field INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ring_size_table ADD position_field INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE chain_size_table DROP position_field');
        $this->addSql('ALTER TABLE insertion_color_table DROP position_field');
        $this->addSql('ALTER TABLE ring_size_table DROP position_field');
    }
}

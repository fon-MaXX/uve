 ...
 */
class Version20170622111527 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ukr_poshta_data_table ADD order_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ukr_poshta_data_table ADD CONSTRAINT FK_95ED4DE58D9F6D38 FOREIGN KEY (order_id) REFERENCES order_table (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_95ED4DE58D9F6D38 ON ukr_poshta_data_table (order_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ukr_poshta_data_table DROP FOREIGN KEY FK_95ED4DE58D9F6D38');
        $this->addSql('DROP INDEX UNIQ_95ED4DE58D9F6D38 ON ukr_poshta_data_table');
        $this->addSql('ALTER TABLE ukr_poshta_data_table DROP order_id');
    }
}

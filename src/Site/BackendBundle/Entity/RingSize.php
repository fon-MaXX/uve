 ...
 * @ORM\Table(name="ring_size_table")
 * @ORM\Entity(repositoryClass="Site\BackendBundle\Entity\Repository\RingSizeRepository")
 */
class RingSize
{
    /**
     ...
     *
     * @ORM\ManyToMany(targetEntity="Product", inversedBy="ringSizes")
     * @ORM\JoinTable(name="product_has_ring_size",
     *   joinColumns={
     *     @ORM\JoinColumn(name="ring_size_id", referencedColumnName="id")
     *   },
     *   inverseJoinColumns={
